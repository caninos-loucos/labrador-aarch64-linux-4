...
static const struct caninos_uart_info k5_info = {
	.tx_fifosize = 16,
};

static const struct caninos_uart_info k7_info = {
	.tx_fifosize = 32,
};

static const struct caninos_uart_info k9_info = {
	.tx_fifosize = 32,
};

static const struct of_device_id caninos_uart_dt_matches[] = {
	{ .compatible = "caninos,k5-uart", .data = &k5_info },
	{ .compatible = "caninos,k7-uart", .data = &k7_info },
	{ .compatible = "caninos,k9-uart", .data = &k9_info },
	{ }
};
