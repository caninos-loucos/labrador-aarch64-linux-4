...
static long umplock_driver_compat_ioctl(struct file *f, unsigned int cmd, unsigned long arg)
{
	return umplock_driver_ioctl(f, cmd, arg);
}
...
#ifdef CONFIG_COMPAT
	.compat_ioctl = umplock_driver_compat_ioctl,
#endif
};
